...
public class MongoResConsumptionBenchmark {
    private static Logger logger = LoggerFactory.getLogger(MongoResConsumptionBenchmark.class);
    private static Long exeCounter = 0L;

    public static void run() throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(MongoResConsumptionBenchmark.class.getSimpleName())
    ...
    public static class MongoDbConf {
        ...
        public void doSetup() {
            ...
            collection = db.getCollection(sensorDataCollectionName);
    ...
    public static List<Document> mongoReadFromSensorData(MongoDbConf mongoDbConf) {
        try  {
            ...
            int itemIdIndex = rand.nextInt(mongoDbConf.itemPropertiesList.size());
            ItemProperties itemProperties = mongoDbConf.itemPropertiesList.get(itemIdIndex);
            ...
            List<Document> docs = MongoDbRead.getTopByItemIdAndProperty(mongoDbConf.collection,
                    null, itemId, property);
